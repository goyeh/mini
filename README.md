...
Return a nice JSON representation of any interface

```go
package main

import (
	"github.com/goyeh/mini/json"
	"fmt"
)

func main() {
    x := map[string]interface{}{"number": 256, "string": "Hello World", "bool": true, "float": 211.05}
